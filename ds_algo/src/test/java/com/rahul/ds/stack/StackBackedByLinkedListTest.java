...
import com.rahul.ds.stack.linkedlistbased.StackBackedByLinkedList;
...
public class StackBackedByLinkedListTest {

    private static StackBackedByLinkedList stack = new StackBackedByLinkedList(10);
